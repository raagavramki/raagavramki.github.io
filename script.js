...
// Add animation to timeline items and other elements
...
document.getElementById('contact-form').addEventListener('submit', function(e) {
    ...
    // Create mailto link
    const mailtoLink = `mailto:raagav.ramakrishnan@students.iiit.ac.in?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(`Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`)}`;
