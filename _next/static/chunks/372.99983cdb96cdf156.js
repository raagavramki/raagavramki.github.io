"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[372],{6372:(e,o,a)=>{a.r(o),a.d(o,{ColorPanels:()=>oF,Dithering:()=>of,DotGrid:()=>el,DotOrbit:()=>eo,FlutedGlass:()=>o2,GodRays:()=>eZ,GrainGradient:()=>o_,HalftoneCmyk:()=>aO,HalftoneDots:()=>aR,Heatmap:()=>ad,ImageDithering:()=>at,LiquidMetal:()=>aA,MeshGradient:()=>E,Metaballs:()=>ey,NeuroNoise:()=>K,PaperTexture:()=>oK,PerlinNoise:()=>eV,PulsingBorder:()=>oB,ShaderMount:()=>p,SimplexNoise:()=>ep,SmokeRing:()=>Q,Spiral:()=>e5,StaticMeshGradient:()=>oY,StaticRadialGradient:()=>oQ,Swirl:()=>e7,Voronoi:()=>eY,Warp:()=>eH,Water:()=>o6,Waves:()=>eB,colorPanelsMeta:()=>oS,colorPanelsPresets:()=>oV,ditheringPresets:()=>on,dotGridPresets:()=>es,dotOrbitMeta:()=>q,dotOrbitPresets:()=>ee,flutedGlassPresets:()=>o1,getShaderColorFromString:()=>_,godRaysMeta:()=>eL,godRaysPresets:()=>eJ,grainGradientMeta:()=>oc,grainGradientPresets:()=>ov,halftoneCmykPresets:()=>aI,halftoneDotsPresets:()=>aU,heatmapMeta:()=>ar,heatmapPresets:()=>ap,imageDitheringPresets:()=>aa,isPaperShaderElement:()=>f,liquidMetalPresets:()=>aw,meshGradientMeta:()=>V,meshGradientPresets:()=>O,metaballsMeta:()=>ed,metaballsPresets:()=>ex,neuroNoisePresets:()=>j,paperTexturePresets:()=>oj,perlinNoisePresets:()=>eR,pulsingBorderMeta:()=>ox,pulsingBorderPresets:()=>oC,simplexNoiseMeta:()=>en,simplexNoisePresets:()=>em,smokeRingMeta:()=>W,smokeRingPresets:()=>N,spiralPresets:()=>e2,staticMeshGradientMeta:()=>oz,staticMeshGradientPresets:()=>oE,staticRadialGradientMeta:()=>oD,staticRadialGradientPresets:()=>oN,swirlMeta:()=>e3,swirlPresets:()=>e6,voronoiMeta:()=>eF,voronoiPresets:()=>eE,warpMeta:()=>eD,warpPresets:()=>eX,waterPresets:()=>o9,wavesPresets:()=>eC});var t=a(2115);let r=`#version 300 es
...
`,T={name:"Default",params:{...g,speed:.5,frame:0,colorBack:"#000000",colors:["#ffffff"],noiseScale:3,noiseIterations:8,radius:.25,thickness:.65,innerShape:.7,scale:.8}},G={name:"Solar",params:{...g,speed:1,frame:0,colorBack:"#000000",colors:["#ffffff","#ffca0a","#fc6203","#fc620366"],noiseScale:2,noiseIterations:3,radius:.4,thickness:.8,innerShape:4,scale:2,offsetY:1}},N=[T,{name:"Line",params:{...g,frame:0,colorBack:"#000000",colors:["#4540a4","#1fe8ff"],noiseScale:1.1,noiseIterations:2,radius:.38,thickness:.01,innerShape:.88,speed:4}},G,{name:"Cloud",params:{...g,frame:0,colorBack:"#81ADEC",colors:["#ffffff"],noiseScale:3,noiseIterations:10,radius:.5,thickness:.65,innerShape:.85,speed:.5,scale:2.5}}],Q=(0,t.memo)(function({speed:e=T.params.speed,frame:o=T.params.frame,colorBack:a=T.params.colorBack,colors:t=T.params.colors,noiseScale:r=T.params.noiseScale,thickness:i=T.params.thickness,radius:s=T.params.radius,innerShape:l=T.params.innerShape,noiseIterations:n=T.params.noiseIterations,fit:f=T.params.fit,scale:c=T.params.scale,rotation:m=T.params.rotation,originX:d=T.params.originX,originY:g=T.params.originY,offsetX:h=T.params.offsetX,offsetY:x=T.params.offsetY,worldWidth:y=T.params.worldWidth,worldHeight:w=T.params.worldHeight,...A}){let b={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_noiseScale:r,u_thickness:i,u_radius:s,u_innerShape:l,u_noiseIterations:n,u_noiseTexture:Y(),u_fit:v[f],u_scale:c,u_rotation:m,u_offsetX:h,u_offsetY:x,u_originX:d,u_originY:g,u_worldWidth:y,u_worldHeight:w};return(0,u.jsx)(p,{...A,speed:e,frame:o,fragmentShader:P,uniforms:b})},d),X=`#version 300 es
precision mediump float;
...
`,Z={name:"Default",params:{...h,speed:1.5,frame:0,colorBack:"#000000",colors:["#ffc96b","#ff6200","#ff2f00","#421100","#1a0000"],size:1,sizeRange:0,spreading:1,stepsPerColor:4}},$={name:"Shine",params:{...h,speed:.1,frame:0,colors:["#ffffff","#006aff","#fff675"],colorBack:"#000000",stepsPerColor:4,size:.3,sizeRange:.2,spreading:1,scale:.4}},ee=[Z,{name:"Bubbles",params:{...h,speed:.4,frame:0,colors:["#D0D2D5"],colorBack:"#989CA4",stepsPerColor:2,size:.9,sizeRange:.7,spreading:1,scale:1.64}},$,{name:"Hallucinatory",params:{...h,speed:5,frame:0,colors:["#000000"],colorBack:"#ffe500",stepsPerColor:2,size:.65,sizeRange:0,spreading:.3,scale:.5}}],eo=(0,t.memo)(function({speed:e=Z.params.speed,frame:o=Z.params.frame,colorBack:a=Z.params.colorBack,colors:t=Z.params.colors,size:r=Z.params.size,sizeRange:i=Z.params.sizeRange,spreading:s=Z.params.spreading,stepsPerColor:l=Z.params.stepsPerColor,fit:n=Z.params.fit,scale:f=Z.params.scale,rotation:c=Z.params.rotation,originX:m=Z.params.originX,originY:d=Z.params.originY,offsetX:g=Z.params.offsetX,offsetY:h=Z.params.offsetY,worldWidth:x=Z.params.worldWidth,worldHeight:y=Z.params.worldHeight,...w}){let A={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_size:r,u_sizeRange:i,u_spreading:s,u_stepsPerColor:l,u_noiseTexture:Y(),u_fit:v[n],u_scale:f,u_rotation:c,u_offsetX:g,u_offsetY:h,u_originX:m,u_originY:d,u_worldWidth:x,u_worldHeight:y};return(0,u.jsx)(p,{...w,speed:e,frame:o,fragmentShader:J,uniforms:A})},d),ea=`#version 300 es
precision mediump float;
...
`,et={circle:0,diamond:1,square:2,triangle:3},er={name:"Default",params:{...h,colorBack:"#000000",colorFill:"#ffffff",colorStroke:"#ffaa00",size:2,gapX:32,gapY:32,strokeWidth:0,sizeRange:0,opacityRange:0,shape:"circle"}},ei={name:"Triangles",params:{...h,colorBack:"#ffffff",colorFill:"#ffffff",colorStroke:"#808080",size:5,gapX:32,gapY:32,strokeWidth:1,sizeRange:0,opacityRange:0,shape:"triangle"}},es=[er,ei,{name:"Tree line",params:{...h,colorBack:"#f4fce7",colorFill:"#052e19",colorStroke:"#000000",size:8,gapX:20,gapY:90,strokeWidth:0,sizeRange:1,opacityRange:.6,shape:"circle"}},{name:"Wallpaper",params:{...h,colorBack:"#204030",colorFill:"#000000",colorStroke:"#bd955b",size:9,gapX:32,gapY:32,strokeWidth:1,sizeRange:0,opacityRange:0,shape:"diamond"}}],el=(0,t.memo)(function({colorBack:e=er.params.colorBack,colorFill:o=er.params.colorFill,colorStroke:a=er.params.colorStroke,size:t=er.params.size,gapX:r=er.params.gapX,gapY:i=er.params.gapY,strokeWidth:s=er.params.strokeWidth,sizeRange:l=er.params.sizeRange,opacityRange:n=er.params.opacityRange,shape:f=er.params.shape,fit:c=er.params.fit,scale:m=er.params.scale,rotation:d=er.params.rotation,originX:g=er.params.originX,originY:h=er.params.originY,offsetX:x=er.params.offsetX,offsetY:y=er.params.offsetY,worldWidth:w=er.params.worldWidth,worldHeight:A=er.params.worldHeight,maxPixelCount:b=0x136a400,...C}){let B={u_colorBack:_(e),u_colorFill:_(o),u_colorStroke:_(a),u_dotSize:t,u_gapX:r,u_gapY:i,u_strokeWidth:s,u_sizeRange:l,u_opacityRange:n,u_shape:et[f],u_fit:v[c],u_scale:m,u_rotation:d,u_offsetX:x,u_offsetY:y,u_originX:g,u_originY:h,u_worldWidth:w,u_worldHeight:A};return(0,u.jsx)(p,{...C,maxPixelCount:b,fragmentShader:ea,uniforms:B})},d),en={maxColorCount:10},ef=`#version 300 es
precision mediump float;

uniform float u_time;
uniform float u_scale;

uniform vec4 u_colors[${en.maxColorCount}];
uniform float u_colorsCount;
uniform float u_stepsPerColor;
...
void main() {
  ...
  vec4 gradient = u_colors[0];
  gradient.rgb *= gradient.a;
  for (int i = 1; i < ${en.maxColorCount}; i++) {
    if (i >= int(u_colorsCount)) break;
...
`,ec={name:"Default",params:{...h,scale:.6,speed:.5,frame:0,colors:["#4449CF","#FFD1E0","#F94446","#FFD36B","#FFFFFF"],stepsPerColor:2,softness:0}},eu={name:"Bubblegum",params:{...h,speed:2,frame:0,colors:["#ffffff","#ff9e9e","#5f57ff","#00f7ff"],stepsPerColor:1,softness:1,scale:1.6}},em=[ec,{name:"Spots",params:{...h,speed:.6,frame:0,colors:["#ff7b00","#f9ffeb","#320d82"],stepsPerColor:1,softness:0,scale:1}},{name:"First contact",params:{...h,speed:2,frame:0,colors:["#e8cce6","#120d22","#442c44","#e6baba","#fff5f5"],stepsPerColor:2,softness:0,scale:.2}},eu],ep=(0,t.memo)(function({speed:e=ec.params.speed,frame:o=ec.params.frame,colors:a=ec.params.colors,stepsPerColor:t=ec.params.stepsPerColor,softness:r=ec.params.softness,fit:i=ec.params.fit,scale:s=ec.params.scale,rotation:l=ec.params.rotation,originX:n=ec.params.originX,originY:f=ec.params.originY,offsetX:c=ec.params.offsetX,offsetY:m=ec.params.offsetY,worldWidth:d=ec.params.worldWidth,worldHeight:g=ec.params.worldHeight,...h}){let x={u_colors:a.map(_),u_colorsCount:a.length,u_stepsPerColor:t,u_softness:r,u_fit:v[i],u_scale:s,u_rotation:l,u_offsetX:c,u_offsetY:m,u_originX:n,u_originY:f,u_worldWidth:d,u_worldHeight:g};return(0,u.jsx)(p,{...h,speed:e,frame:o,fragmentShader:ef,uniforms:x})},d),ed={maxColorCount:8,maxBallsCount:20},eg=`#version 300 es
precision mediump float;
...
void main() {
  ...
  for (int i = 0; i < ${ed.maxBallsCount}; i++) {
    if (i >= int(ceil(u_count))) break;

    float idxFract = float(i) / float(${ed.maxBallsCount});
...
`,eh={name:"Default",params:{...g,scale:1,speed:1,frame:0,colorBack:"#000000",colors:["#6e33cc","#ff5500","#ffc105","#ffc800","#f585ff"],count:10,size:.83}},ev={name:"Ink Drops",params:{...g,scale:1,speed:2,frame:0,colorBack:"#ffffff00",colors:["#000000"],count:18,size:.1}},e_={name:"Background",params:{...g,speed:.5,frame:0,colors:["#ae00ff","#00ff95","#ffc105"],colorBack:"#2a273f",count:13,size:.81,scale:4,rotation:0,offsetX:-.3}},ex=[eh,ev,{name:"Solar",params:{...g,speed:1,frame:0,colors:["#ffc800","#ff5500","#ffc105"],colorBack:"#102f84",count:7,size:.75,scale:1}},e_],ey=(0,t.memo)(function({speed:e=eh.params.speed,frame:o=eh.params.frame,colorBack:a=eh.params.colorBack,colors:t=eh.params.colors,size:r=eh.params.size,count:i=eh.params.count,fit:s=eh.params.fit,rotation:l=eh.params.rotation,scale:n=eh.params.scale,originX:f=eh.params.originX,originY:c=eh.params.originY,offsetX:m=eh.params.offsetX,offsetY:d=eh.params.offsetY,worldWidth:g=eh.params.worldWidth,worldHeight:h=eh.params.worldHeight,...x}){let y={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_size:r,u_count:i,u_noiseTexture:Y(),u_fit:v[s],u_rotation:l,u_scale:n,u_offsetX:m,u_offsetY:d,u_originX:f,u_originY:c,u_worldWidth:g,u_worldHeight:h};return(0,u.jsx)(p,{...x,speed:e,frame:o,fragmentShader:eg,uniforms:y})},d),ew=`#version 300 es
precision mediump float;
...
`,eA={name:"Default",params:{...h,scale:.6,colorFront:"#ffbb00",colorBack:"#000000",shape:0,frequency:.5,amplitude:.5,spacing:1.2,proportion:.1,softness:0}},eb={name:"Groovy",params:{...h,scale:5,rotation:90,colorFront:"#fcfcee",colorBack:"#ff896b",shape:3,frequency:.2,amplitude:.25,spacing:1.17,proportion:.57,softness:0}},eC=[eA,eb,{name:"Tangled up",params:{...h,scale:.5,rotation:0,colorFront:"#133a41",colorBack:"#c2d8b6",shape:2.07,frequency:.44,amplitude:.57,spacing:1.05,proportion:.75,softness:0}},{name:"Ride the wave",params:{...h,scale:1.7,rotation:0,colorFront:"#fdffe6",colorBack:"#1f1f1f",shape:2.25,frequency:.2,amplitude:1,spacing:1.25,proportion:1,softness:0}}],eB=(0,t.memo)(function({colorFront:e=eA.params.colorFront,colorBack:o=eA.params.colorBack,shape:a=eA.params.shape,frequency:t=eA.params.frequency,amplitude:r=eA.params.amplitude,spacing:i=eA.params.spacing,proportion:s=eA.params.proportion,softness:l=eA.params.softness,fit:n=eA.params.fit,scale:f=eA.params.scale,rotation:c=eA.params.rotation,offsetX:m=eA.params.offsetX,offsetY:d=eA.params.offsetY,originX:g=eA.params.originX,originY:h=eA.params.originY,worldWidth:x=eA.params.worldWidth,worldHeight:y=eA.params.worldHeight,maxPixelCount:w=0x136a400,...A}){let b={u_colorFront:_(e),u_colorBack:_(o),u_shape:a,u_frequency:t,u_amplitude:r,u_spacing:i,u_proportion:s,u_softness:l,u_fit:v[n],u_scale:f,u_rotation:c,u_offsetX:m,u_offsetY:d,u_originX:g,u_originY:h,u_worldWidth:x,u_worldHeight:y};return(0,u.jsx)(p,{...A,fragmentShader:ew,uniforms:b})},d),eS=`#version 300 es
precision mediump float;
...
`,ek={name:"Default",params:{...h,speed:.5,frame:0,colorBack:"#632ad5",colorFront:"#fccff7",proportion:.35,softness:.1,octaveCount:1,persistence:1,lacunarity:1.5}},eU={name:"Nintendo Water",params:{...h,scale:5,speed:.4,frame:0,colorBack:"#2d69d4",colorFront:"#d1eefc",proportion:.42,softness:0,octaveCount:2,persistence:.55,lacunarity:1.8}},eR=[ek,eU,{name:"Moss",params:{...h,scale:1/.15,speed:.02,frame:0,colorBack:"#05ff4a",colorFront:"#262626",proportion:.65,softness:.35,octaveCount:6,persistence:1,lacunarity:2.55}},{name:"Worms",params:{...h,scale:.9,speed:0,frame:0,colorBack:"#ffffff00",colorFront:"#595959",proportion:.5,softness:0,octaveCount:1,persistence:1,lacunarity:1.5}}],eV=(0,t.memo)(function({speed:e=ek.params.speed,frame:o=ek.params.frame,colorFront:a=ek.params.colorFront,colorBack:t=ek.params.colorBack,proportion:r=ek.params.proportion,softness:i=ek.params.softness,octaveCount:s=ek.params.octaveCount,persistence:l=ek.params.persistence,lacunarity:n,fit:f=ek.params.fit,worldWidth:c=ek.params.worldWidth,worldHeight:m=ek.params.worldHeight,scale:d=ek.params.scale,rotation:g=ek.params.rotation,originX:h=ek.params.originX,originY:x=ek.params.originY,offsetX:y=ek.params.offsetX,offsetY:w=ek.params.offsetY,...A}){let b={u_colorBack:_(t),u_colorFront:_(a),u_proportion:r,u_softness:i??ek.params.softness,u_octaveCount:s??ek.params.octaveCount,u_persistence:l??ek.params.persistence,u_lacunarity:n??ek.params.lacunarity,u_fit:v[f],u_scale:d,u_rotation:g,u_offsetX:y,u_offsetY:w,u_originX:h,u_originY:x,u_worldWidth:c,u_worldHeight:m};return(0,u.jsx)(p,{...A,speed:e,frame:o,fragmentShader:eS,uniforms:b})},d),eF={maxColorCount:5},ez=`#version 300 es
precision mediump float;
...
`,eM={name:"Default",params:{...h,speed:.5,frame:0,colors:["#ff8247","#ffe53d"],stepsPerColor:3,colorGlow:"#ffffff",colorGap:"#2e0000",distortion:.4,gap:.04,glow:0,scale:.5}},eI={name:"Cells",params:{...h,scale:.5,speed:.5,frame:0,colors:["#ffffff"],stepsPerColor:1,colorGlow:"#ffffff",colorGap:"#000000",distortion:.5,gap:.03,glow:.8}},eO={name:"Bubbles",params:{...h,scale:.75,speed:.5,frame:0,colors:["#83c9fb"],stepsPerColor:1,colorGlow:"#ffffff",colorGap:"#ffffff",distortion:.4,gap:0,glow:1}},eE=[eM,{name:"Lights",params:{...h,scale:3.3,speed:.5,frame:0,colors:["#fffffffc","#bbff00","#00ffff"],colorGlow:"#ff00d0",colorGap:"#ff00d0",stepsPerColor:2,distortion:.38,gap:0,glow:1}},eI,eO],eY=(0,t.memo)(function({speed:e=eM.params.speed,frame:o=eM.params.frame,colors:a=eM.params.colors,stepsPerColor:t=eM.params.stepsPerColor,colorGlow:r=eM.params.colorGlow,colorGap:i=eM.params.colorGap,distortion:s=eM.params.distortion,gap:l=eM.params.gap,glow:n=eM.params.glow,fit:f=eM.params.fit,scale:c=eM.params.scale,rotation:m=eM.params.rotation,originX:d=eM.params.originX,originY:g=eM.params.originY,offsetX:h=eM.params.offsetX,offsetY:x=eM.params.offsetY,worldWidth:y=eM.params.worldWidth,worldHeight:w=eM.params.worldHeight,...A}){let b={u_colors:a.map(_),u_colorsCount:a.length,u_stepsPerColor:t,u_colorGlow:_(r),u_colorGap:_(i),u_distortion:s,u_gap:l,u_glow:n,u_noiseTexture:Y(),u_fit:v[f],u_scale:c,u_rotation:m,u_offsetX:h,u_offsetY:x,u_originX:d,u_originY:g,u_worldWidth:y,u_worldHeight:w};return(0,u.jsx)(p,{...A,speed:e,frame:o,fragmentShader:ez,uniforms:b})},d),eD={maxColorCount:10},eW=`#version 300 es
precision mediump float;
...
void main() {
  ...
  for (int i = 1; i < ${eD.maxColorCount}; i++) {
    if (i >= int(u_colorsCount)) break;
...
`,eP={checks:0,stripes:1,edge:2},eT={name:"Default",params:{...h,rotation:0,speed:1,frame:0,colors:["#121212","#9470ff","#121212","#8838ff"],proportion:.45,softness:1,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.1,shape:"checks"}},eG={name:"Cauldron Pot",params:{...h,scale:.9,rotation:160,speed:10,frame:0,colors:["#a7e58b","#324472","#0a180d"],proportion:.64,softness:1.5,distortion:.2,swirl:.86,swirlIterations:7,shapeScale:.6,shape:"edge"}},eN={name:"Live Ink",params:{...h,scale:1.2,rotation:44,offsetY:-.3,speed:2.5,frame:0,colors:["#111314","#9faeab","#f3fee7","#f3fee7"],proportion:.05,softness:0,distortion:.25,swirl:.8,swirlIterations:10,shapeScale:.28,shape:"checks"}},eQ={name:"Kelp",params:{...h,scale:.8,rotation:50,speed:20,frame:0,colors:["#dbff8f","#404f3e","#091316"],proportion:.67,softness:0,distortion:0,swirl:.2,swirlIterations:3,shapeScale:1,shape:"stripes"}},eX=[eT,eG,eN,eQ,{name:"Nectar",params:{...h,scale:2,offsetY:.6,rotation:0,speed:4.2,frame:0,colors:["#151310","#d3a86b","#f0edea"],proportion:.24,softness:1,distortion:.21,swirl:.57,swirlIterations:10,shapeScale:.75,shape:"edge"}},{name:"Passion",params:{...h,scale:2.5,rotation:1.35,speed:3,frame:0,colors:["#3b1515","#954751","#ffc085"],proportion:.5,softness:1,distortion:.09,swirl:.9,swirlIterations:6,shapeScale:.25,shape:"checks"}}],eH=(0,t.memo)(function({speed:e=eT.params.speed,frame:o=eT.params.frame,colors:a=eT.params.colors,proportion:t=eT.params.proportion,softness:r=eT.params.softness,distortion:i=eT.params.distortion,swirl:s=eT.params.swirl,swirlIterations:l=eT.params.swirlIterations,shapeScale:n=eT.params.shapeScale,shape:f=eT.params.shape,fit:c=eT.params.fit,scale:m=eT.params.scale,rotation:d=eT.params.rotation,originX:g=eT.params.originX,originY:h=eT.params.originY,offsetX:x=eT.params.offsetX,offsetY:y=eT.params.offsetY,worldWidth:w=eT.params.worldWidth,worldHeight:A=eT.params.worldHeight,...b}){let C={u_colors:a.map(_),u_colorsCount:a.length,u_proportion:t,u_softness:r,u_distortion:i,u_swirl:s,u_swirlIterations:l,u_shapeScale:n,u_shape:eP[f],u_noiseTexture:Y(),u_scale:m,u_rotation:d,u_fit:v[c],u_offsetX:x,u_offsetY:y,u_originX:g,u_originY:h,u_worldWidth:w,u_worldHeight:A};return(0,u.jsx)(p,{...b,speed:e,frame:o,fragmentShader:eW,uniforms:C})},d),eL={maxColorCount:5},ej=`#version 300 es
precision mediump float;
...
void main() {
  ...
  for (int i = 0; i < ${eL.maxColorCount}; i++) {
    if (i >= int(u_colorsCount)) break;
...
`,eK={name:"Default",params:{...g,offsetX:0,offsetY:-.55,colorBack:"#000000",colorBloom:"#0000ff",colors:["#a600ff6e","#6200fff0","#ffffff","#33fff5"],density:.3,spotty:.3,midIntensity:.4,midSize:.2,intensity:.8,bloom:.4,speed:.75,frame:0}},eq={name:"Warp",params:{...g,colorBack:"#000000",colorBloom:"#222288",colors:["#ff47d4","#ff8c00","#ffffff"],density:.45,spotty:.15,midIntensity:.4,midSize:.33,intensity:.79,bloom:.4,speed:2,frame:0}},eJ=[eK,eq,{name:"Linear",params:{...g,offsetX:.2,offsetY:-.8,colorBack:"#000000",colorBloom:"#eeeeee",colors:["#ffffff1f","#ffffff3d","#ffffff29"],density:.41,spotty:.25,midSize:.1,midIntensity:.75,intensity:.79,bloom:1,speed:.5,frame:0}},{name:"Ether",params:{...g,offsetX:-.6,colorBack:"#090f1d",colorBloom:"#ffffff",colors:["#148effa6","#c4dffebe","#232a47"],density:.03,spotty:.77,midSize:.1,midIntensity:.6,intensity:.6,bloom:.6,speed:1,frame:0}}],eZ=(0,t.memo)(function({speed:e=eK.params.speed,frame:o=eK.params.frame,colorBloom:a=eK.params.colorBloom,colorBack:t=eK.params.colorBack,colors:r=eK.params.colors,density:i=eK.params.density,spotty:s=eK.params.spotty,midIntensity:l=eK.params.midIntensity,midSize:n=eK.params.midSize,intensity:f=eK.params.intensity,bloom:c=eK.params.bloom,fit:m=eK.params.fit,scale:d=eK.params.scale,rotation:g=eK.params.rotation,originX:h=eK.params.originX,originY:x=eK.params.originY,offsetX:y=eK.params.offsetX,offsetY:w=eK.params.offsetY,worldWidth:A=eK.params.worldWidth,worldHeight:b=eK.params.worldHeight,...C}){let B={u_colorBloom:_(a),u_colorBack:_(t),u_colors:r.map(_),u_colorsCount:r.length,u_density:i,u_spotty:s,u_midIntensity:l,u_midSize:n,u_intensity:f,u_bloom:c,u_noiseTexture:Y(),u_fit:v[m],u_scale:d,u_rotation:g,u_offsetX:y,u_offsetY:w,u_originX:h,u_originY:x,u_worldWidth:A,u_worldHeight:b};return(0,u.jsx)(p,{...C,speed:e,frame:o,fragmentShader:ej,uniforms:B})},d),e$=`#version 300 es
precision mediump float;
...
`,e0={name:"Default",params:{...h,scale:1,colorBack:"#001429",colorFront:"#79D1FF",density:1,distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:0,noiseFrequency:0,softness:0,speed:1,frame:0}},e1={name:"Droplet",params:{...h,colorBack:"#effafe",colorFront:"#bf40a0",density:.9,distortion:0,strokeWidth:.75,strokeTaper:.18,strokeCap:1,noise:.74,noiseFrequency:.33,softness:.02,speed:1,frame:0}},e2=[e0,{name:"Jungle",params:{...h,scale:1.3,density:.5,colorBack:"#a0ef2a",colorFront:"#288b18",distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:1,noiseFrequency:.25,softness:0,speed:.75,frame:0}},e1,{name:"Swirl",params:{...h,scale:.45,colorBack:"#b3e6d9",colorFront:"#1a2b4d",density:.2,distortion:0,strokeWidth:.5,strokeTaper:0,strokeCap:0,noise:0,noiseFrequency:.3,softness:.5,speed:1,frame:0}}],e5=(0,t.memo)(function({speed:e=e0.params.speed,frame:o=e0.params.frame,colorBack:a=e0.params.colorBack,colorFront:t=e0.params.colorFront,density:r=e0.params.density,distortion:i=e0.params.distortion,strokeWidth:s=e0.params.strokeWidth,strokeTaper:l=e0.params.strokeTaper,strokeCap:n=e0.params.strokeCap,noiseFrequency:f=e0.params.noiseFrequency,noise:c=e0.params.noise,softness:m=e0.params.softness,fit:d=e0.params.fit,rotation:g=e0.params.rotation,scale:h=e0.params.scale,originX:x=e0.params.originX,originY:y=e0.params.originY,offsetX:w=e0.params.offsetX,offsetY:A=e0.params.offsetY,worldWidth:b=e0.params.worldWidth,worldHeight:C=e0.params.worldHeight,...B}){let S={u_colorBack:_(a),u_colorFront:_(t),u_density:r,u_distortion:i,u_strokeWidth:s,u_strokeTaper:l,u_strokeCap:n,u_noiseFrequency:f,u_noise:c,u_softness:m,u_fit:v[d],u_scale:h,u_rotation:g,u_offsetX:w,u_offsetY:A,u_originX:x,u_originY:y,u_worldWidth:b,u_worldHeight:C};return(0,u.jsx)(p,{...B,speed:e,frame:o,fragmentShader:e$,uniforms:S})},d),e3={maxColorCount:10},e4=`#version 300 es
precision mediump float;

uniform float u_time;

uniform vec4 u_colorBack;
uniform vec4 u_colors[${e3.maxColorCount}];
uniform float u_colorsCount;
...
void main() {
  ...
  float outerShape = 0.;
  for (int i = 1; i < ${e3.maxColorCount+1}; i++) {
    if (i > int(u_colorsCount)) break;
...
`,e8={name:"Default",params:{...g,speed:.32,frame:0,colorBack:"#330000",colors:["#ffd1d1","#ff8a8a","#660000"],bandCount:4,twist:.1,center:.2,proportion:.5,softness:0,noiseFrequency:.4,noise:.2}},e9={name:"Opening",params:{...g,offsetX:-.4,offsetY:1,speed:.5,frame:0,colorBack:"#ff8b61",colors:["#fefff0","#ffd8bd","#ff8b61"],bandCount:2,twist:.3,center:.2,proportion:.5,softness:0,noiseFrequency:0,noise:0,scale:1}},e6=[e8,{name:"007",params:{...g,speed:1,frame:0,colorBack:"#E9E7DA",colors:["#000000"],bandCount:5,twist:.3,center:0,proportion:0,softness:0,noiseFrequency:.5,noise:0}},e9,{name:"Candy",params:{...g,speed:1,frame:0,colorBack:"#ffcd66",colors:["#6bbceb","#d7b3ff","#ff9fff"],bandCount:2,twist:.15,center:.2,proportion:.5,softness:1,noiseFrequency:.5,noise:0}}],e7=(0,t.memo)(function({speed:e=e8.params.speed,frame:o=e8.params.frame,colorBack:a=e8.params.colorBack,colors:t=e8.params.colors,bandCount:r=e8.params.bandCount,twist:i=e8.params.twist,center:s=e8.params.center,proportion:l=e8.params.proportion,softness:n=e8.params.softness,noiseFrequency:f=e8.params.noiseFrequency,noise:c=e8.params.noise,fit:m=e8.params.fit,rotation:d=e8.params.rotation,scale:g=e8.params.scale,originX:h=e8.params.originX,originY:x=e8.params.originY,offsetX:y=e8.params.offsetX,offsetY:w=e8.params.offsetY,worldWidth:A=e8.params.worldWidth,worldHeight:b=e8.params.worldHeight,...C}){let B={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_bandCount:r,u_twist:i,u_center:s,u_proportion:l,u_softness:n,u_noiseFrequency:f,u_noise:c,u_fit:v[m],u_scale:g,u_rotation:d,u_offsetX:y,u_offsetY:w,u_originX:h,u_originY:x,u_worldWidth:A,u_worldHeight:b};return(0,u.jsx)(p,{...C,speed:e,frame:o,fragmentShader:e4,uniforms:B})},d),oe=`#version 300 es
precision mediump float;
...
`,oo={simplex:1,warp:2,dots:3,wave:4,ripple:5,swirl:6,sphere:7},oa={random:1,"2x2":2,"4x4":3,"8x8":4},ot={name:"Default",params:{...h,speed:1,frame:0,scale:.6,colorBack:"#000000",colorFront:"#00b2ff",shape:"sphere",type:"4x4",size:2}},or={name:"Sine Wave",params:{...h,speed:1,frame:0,colorBack:"#730d54",colorFront:"#00becc",shape:"wave",type:"4x4",size:11,scale:1.2}},oi={name:"Bugs",params:{...h,speed:1,frame:0,colorBack:"#000000",colorFront:"#008000",shape:"dots",type:"random",size:9}},os={name:"Ripple",params:{...g,speed:1,frame:0,colorBack:"#603520",colorFront:"#c67953",shape:"ripple",type:"2x2",size:3}},ol={name:"Swirl",params:{...g,speed:1,frame:0,colorBack:"#00000000",colorFront:"#47a8e1",shape:"swirl",type:"8x8",size:2}},on=[ot,{name:"Warp",params:{...g,speed:1,frame:0,colorBack:"#301c2a",colorFront:"#56ae6c",shape:"warp",type:"4x4",size:2.5}},or,os,oi,ol],of=(0,t.memo)(function({speed:e=ot.params.speed,frame:o=ot.params.frame,colorBack:a=ot.params.colorBack,colorFront:t=ot.params.colorFront,shape:r=ot.params.shape,type:i=ot.params.type,pxSize:s,size:l=void 0===s?ot.params.size:s,fit:n=ot.params.fit,scale:f=ot.params.scale,rotation:c=ot.params.rotation,originX:m=ot.params.originX,originY:d=ot.params.originY,offsetX:g=ot.params.offsetX,offsetY:h=ot.params.offsetY,worldWidth:x=ot.params.worldWidth,worldHeight:y=ot.params.worldHeight,...w}){let A={u_colorBack:_(a),u_colorFront:_(t),u_shape:oo[r],u_type:oa[i],u_pxSize:l,u_fit:v[n],u_scale:f,u_rotation:c,u_offsetX:g,u_offsetY:h,u_originX:m,u_originY:d,u_worldWidth:x,u_worldHeight:y};return(0,u.jsx)(p,{...w,speed:e,frame:o,fragmentShader:oe,uniforms:A})}),oc={maxColorCount:7},ou=`#version 300 es
...
uniform vec4 u_colorBack;
uniform vec4 u_colors[${oc.maxColorCount}];
uniform float u_colorsCount;
uniform float u_softness;
uniform float u_intensity;
uniform float u_noise;
...
void main() {
  ...
  vec4 gradient = u_colors[0];
  gradient.rgb *= gradient.a;
  for (int i = 1; i < ${oc.maxColorCount}; i++) {
    if (i > cntStop) break;
...
`,om={wave:1,dots:2,truchet:3,corners:4,ripple:5,blob:6,sphere:7},op={name:"Default",params:{...g,speed:1,frame:0,colorBack:"#000000",colors:["#7300ff","#eba8ff","#00bfff","#2a00ff"],softness:.5,intensity:.5,noise:.25,shape:"corners"}},od={name:"Wave",params:{...h,speed:1,frame:0,colorBack:"#000a0f",colors:["#c4730b","#bdad5f","#d8ccc7"],softness:.7,intensity:.15,noise:.5,shape:"wave"}},og={name:"Dots",params:{...h,scale:.6,speed:1,frame:0,colorBack:"#0a0000",colors:["#6f0000","#0080ff","#f2ebc9","#33cc33"],softness:1,intensity:1,noise:.7,shape:"dots"}},oh={name:"Truchet",params:{...h,speed:1,frame:0,colorBack:"#0a0000",colors:["#6f2200","#eabb7c","#39b523"],softness:0,intensity:.2,noise:1,shape:"truchet"}},ov=[op,od,og,oh,{name:"Ripple",params:{...g,scale:.5,speed:1,frame:0,colorBack:"#140a00",colors:["#6f2d00","#88ddae","#2c0b1d"],softness:.5,intensity:.5,noise:.5,shape:"ripple"}},{name:"Blob",params:{...g,scale:1.3,speed:1,frame:0,colorBack:"#0f0e18",colors:["#3e6172","#a49b74","#568c50"],softness:0,intensity:.15,noise:.5,shape:"blob"}}],o_=(0,t.memo)(function({speed:e=op.params.speed,frame:o=op.params.frame,colorBack:a=op.params.colorBack,colors:t=op.params.colors,softness:r=op.params.softness,intensity:i=op.params.intensity,noise:s=op.params.noise,shape:l=op.params.shape,fit:n=op.params.fit,scale:f=op.params.scale,rotation:c=op.params.rotation,originX:m=op.params.originX,originY:d=op.params.originY,offsetX:g=op.params.offsetX,offsetY:h=op.params.offsetY,worldWidth:x=op.params.worldWidth,worldHeight:y=op.params.worldHeight,...w}){let A={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_softness:r,u_intensity:i,u_noise:s,u_shape:om[l],u_noiseTexture:Y(),u_fit:v[n],u_scale:f,u_rotation:c,u_offsetX:g,u_offsetY:h,u_originX:m,u_originY:d,u_worldWidth:x,u_worldHeight:y};return(0,u.jsx)(p,{...w,speed:e,frame:o,fragmentShader:ou,uniforms:A})}),ox={maxColorCount:5,maxSpots:4},oy=`#version 300 es
precision lowp float;
...
void main() {
  ...
  fragColor = vec4(color, opacity);
}`,ow={auto:0,square:1},oA={name:"Default",params:{...g,speed:1,frame:0,scale:.6,colorBack:"#000000",colors:["#0dc1fd","#d915ef","#ff3f2ecc"],roundness:.25,thickness:.1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",softness:.75,intensity:.2,bloom:.25,spots:5,spotSize:.5,pulse:.25,smoke:.3,smokeSize:.6}},ob={name:"Circle",params:{...g,aspectRatio:"square",scale:.6,speed:1,frame:0,colorBack:"#000000",colors:["#0dc1fd","#d915ef","#ff3f2ecc"],roundness:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,thickness:0,softness:.75,intensity:.2,bloom:.45,spots:3,spotSize:.4,pulse:.5,smoke:1,smokeSize:0}},oC=[oA,ob,{name:"Northern lights",params:{...g,speed:.18,scale:1.1,frame:0,colors:["#4c4794","#774a7d","#12694a","#0aff78","#4733cc"],colorBack:"#0c182c",roundness:0,thickness:1,softness:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",intensity:.1,bloom:.2,spots:4,spotSize:.25,pulse:0,smoke:.32,smokeSize:.5}},{name:"Solid line",params:{...g,speed:1,frame:0,colors:["#81ADEC"],colorBack:"#00000000",roundness:0,thickness:.05,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,aspectRatio:"auto",softness:0,intensity:0,bloom:.15,spots:4,spotSize:1,pulse:0,smoke:0,smokeSize:0}}],oB=(0,t.memo)(function({speed:e=oA.params.speed,frame:o=oA.params.frame,colors:a=oA.params.colors,colorBack:t=oA.params.colorBack,roundness:r=oA.params.roundness,thickness:i=oA.params.thickness,aspectRatio:s=oA.params.aspectRatio,softness:l=oA.params.softness,bloom:n=oA.params.bloom,intensity:f=oA.params.intensity,spots:c=oA.params.spots,spotSize:m=oA.params.spotSize,pulse:d=oA.params.pulse,smoke:g=oA.params.smoke,smokeSize:h=oA.params.smokeSize,margin:x,marginLeft:y=x??oA.params.marginLeft,marginRight:w=x??oA.params.marginRight,marginTop:A=x??oA.params.marginTop,marginBottom:b=x??oA.params.marginBottom,fit:C=oA.params.fit,rotation:B=oA.params.rotation,scale:S=oA.params.scale,originX:k=oA.params.originX,originY:U=oA.params.originY,offsetX:R=oA.params.offsetX,offsetY:V=oA.params.offsetY,worldWidth:F=oA.params.worldWidth,worldHeight:z=oA.params.worldHeight,...M}){let I={u_colorBack:_(t),u_colors:a.map(_),u_colorsCount:a.length,u_roundness:r,u_thickness:i,u_marginLeft:y,u_marginRight:w,u_marginTop:A,u_marginBottom:b,u_aspectRatio:ow[s],u_softness:l,u_intensity:f,u_bloom:n,u_spots:c,u_spotSize:m,u_pulse:d,u_smoke:g,u_smokeSize:h,u_noiseTexture:Y(),u_fit:v[C],u_rotation:B,u_scale:S,u_offsetX:R,u_offsetY:V,u_originX:k,u_originY:U,u_worldWidth:F,u_worldHeight:z};return(0,u.jsx)(p,{...M,speed:e,frame:o,fragmentShader:oy,uniforms:I})},d),oS={maxColorCount:7},ok=`#version 300 es
precision lowp float;
...
void main() {
  ...
  vec4 premultipliedColors[${oS.maxColorCount}];
  for (int i = 0; i < ${oS.maxColorCount}; i++) {
...
`,oU={name:"Default",params:{...g,speed:.5,frame:0,colors:["#ff9d00","#fd4f30","#809bff","#6d2eff","#333aff","#f15cff","#ffd557"],colorBack:"#000000",angle1:0,angle2:0,length:1.1,edges:!1,blur:0,fadeIn:1,fadeOut:.3,gradient:0,density:3,scale:.8}},oR={name:"Glass",params:{...g,rotation:112,speed:1,frame:0,colors:["#00cfff","#ff2d55","#34c759","#af52de"],colorBack:"#ffffff00",angle1:.3,angle2:.3,length:1,edges:!0,blur:.25,fadeIn:.85,fadeOut:.3,gradient:0,density:1.6}},oV=[oU,oR,{name:"Gradient",params:{...g,speed:.5,frame:0,colors:["#f2ff00","#00000000","#00000000","#5a0283","#005eff"],colorBack:"#8ffff2",angle1:.4,angle2:.4,length:3,edges:!1,blur:.5,fadeIn:1,fadeOut:.39,gradient:.78,density:1.65,scale:1.72,rotation:270,offsetX:.18}},{name:"Opening",params:{...g,speed:2,frame:0,colors:["#00ffff"],colorBack:"#570044",angle1:-1,angle2:-1,length:.52,edges:!1,blur:0,fadeIn:0,fadeOut:1,gradient:0,density:2.21,scale:2.32,rotation:360,offsetX:-.3,offsetY:.6}}],oF=(0,t.memo)(function({speed:e=oU.params.speed,frame:o=oU.params.frame,colors:a=oU.params.colors,colorBack:t=oU.params.colorBack,angle1:r=oU.params.angle1,angle2:i=oU.params.angle2,length:s=oU.params.length,edges:l=oU.params.edges,blur:n=oU.params.blur,fadeIn:f=oU.params.fadeIn,fadeOut:c=oU.params.fadeOut,density:m=oU.params.density,gradient:d=oU.params.gradient,fit:g=oU.params.fit,scale:h=oU.params.scale,rotation:x=oU.params.rotation,originX:y=oU.params.originX,originY:w=oU.params.originY,offsetX:A=oU.params.offsetX,offsetY:b=oU.params.offsetY,worldWidth:C=oU.params.worldWidth,worldHeight:B=oU.params.worldHeight,...S}){let k={u_colors:a.map(_),u_colorsCount:a.length,u_colorBack:_(t),u_angle1:r,u_angle2:i,u_length:s,u_edges:l,u_blur:n,u_fadeIn:f,u_fadeOut:c,u_density:m,u_gradient:d,u_fit:v[g],u_scale:h,u_rotation:x,u_offsetX:A,u_offsetY:b,u_originX:y,u_originY:w,u_worldWidth:C,u_worldHeight:B};return(0,u.jsx)(p,{...S,speed:e,frame:o,fragmentShader:ok,uniforms:k})},d),oz={maxColorCount:10},oM=`#version 300 es
precision mediump float;
...
void main() {
  ...
  for (int i = 0; i < ${oz.maxColorCount}; i++) {
    if (i >= int(u_colorsCount)) break;
...
`,oI={name:"Default",params:{...g,rotation:270,speed:0,frame:0,colors:["#ffad0a","#6200ff","#e2a3ff","#ff99fd"],positions:2,waveX:1,waveXShift:.6,waveY:1,waveYShift:.21,mixing:.93,grainMixer:0,grainOverlay:0}},oO={name:"Sea",params:{...g,speed:0,frame:0,colors:["#013b65","#03738c","#a3d3ff","#f2faef"],positions:0,waveX:.53,waveXShift:0,waveY:.95,waveYShift:.64,mixing:.5,grainMixer:0,grainOverlay:0}},oE=[oI,{name:"1960s",params:{...g,speed:0,frame:0,colors:["#000000","#082400","#b1aa91","#8e8c15"],positions:42,waveX:.45,waveXShift:0,waveY:1,waveYShift:0,mixing:0,grainMixer:.37,grainOverlay:.78}},{name:"Sunset",params:{...g,speed:0,frame:0,colors:["#264653","#9c2b2b","#f4a261","#ffffff"],positions:0,waveX:.6,waveXShift:.7,waveY:.7,waveYShift:.7,mixing:.5,grainMixer:0,grainOverlay:0}},oO],oY=(0,t.memo)(function({speed:e=oI.params.speed,frame:o=oI.params.frame,colors:a=oI.params.colors,positions:t=oI.params.positions,waveX:r=oI.params.waveX,waveXShift:i=oI.params.waveXShift,waveY:s=oI.params.waveY,waveYShift:l=oI.params.waveYShift,mixing:n=oI.params.mixing,grainMixer:f=oI.params.grainMixer,grainOverlay:c=oI.params.grainOverlay,fit:m=oI.params.fit,rotation:d=oI.params.rotation,scale:g=oI.params.scale,originX:h=oI.params.originX,originY:x=oI.params.originY,offsetX:y=oI.params.offsetX,offsetY:w=oI.params.offsetY,worldWidth:A=oI.params.worldWidth,worldHeight:b=oI.params.worldHeight,...C}){let B={u_colors:a.map(_),u_colorsCount:a.length,u_positions:t,u_waveX:r,u_waveXShift:i,u_waveY:s,u_waveYShift:l,u_mixing:n,u_grainMixer:f,u_grainOverlay:c,u_fit:v[m],u_rotation:d,u_scale:g,u_offsetX:y,u_offsetY:w,u_originX:h,u_originY:x,u_worldWidth:A,u_worldHeight:b};return(0,u.jsx)(p,{...C,speed:e,frame:o,fragmentShader:oM,uniforms:B})},d),oD={maxColorCount:10},oW=`#version 300 es
precision mediump float;
...
`,oP={name:"Default",params:{...g,scale:1,speed:0,frame:0,colorBack:"#000000",colors:["#00bbff","#00ffe1","#ffffff"],radius:.8,focalDistance:.99,focalAngle:0,falloff:.24,mixing:.5,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},oT={name:"Cross Section",params:{...g,scale:1,speed:0,frame:0,colorBack:"#3d348b",colors:["#7678ed","#f7b801","#f18701","#37a066"],radius:1,focalDistance:0,focalAngle:0,falloff:0,mixing:0,distortion:1,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},oG={name:"Radial",params:{...g,scale:1,speed:0,frame:0,colorBack:"#264653",colors:["#9c2b2b","#f4a261","#ffffff"],radius:1,focalDistance:0,focalAngle:0,falloff:0,mixing:1,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:0,grainOverlay:0}},oN=[oP,{name:"Lo-Fi",params:{...g,speed:0,frame:0,colorBack:"#2e1f27",colors:["#d72638","#3f88c5","#f49d37"],radius:1,focalDistance:0,focalAngle:0,falloff:.9,mixing:.7,distortion:0,distortionShift:0,distortionFreq:12,grainMixer:1,grainOverlay:.5}},oT,oG],oQ=(0,t.memo)(function({speed:e=oP.params.speed,frame:o=oP.params.frame,colorBack:a=oP.params.colorBack,colors:t=oP.params.colors,radius:r=oP.params.radius,focalDistance:i=oP.params.focalDistance,focalAngle:s=oP.params.focalAngle,falloff:l=oP.params.falloff,grainMixer:n=oP.params.grainMixer,mixing:f=oP.params.mixing,distortion:c=oP.params.distortion,distortionShift:m=oP.params.distortionShift,distortionFreq:d=oP.params.distortionFreq,grainOverlay:g=oP.params.grainOverlay,fit:h=oP.params.fit,rotation:x=oP.params.rotation,scale:y=oP.params.scale,originX:w=oP.params.originX,originY:A=oP.params.originY,offsetX:b=oP.params.offsetX,offsetY:C=oP.params.offsetY,worldWidth:B=oP.params.worldWidth,worldHeight:S=oP.params.worldHeight,...k}){let U={u_colorBack:_(a),u_colors:t.map(_),u_colorsCount:t.length,u_radius:r,u_focalDistance:i,u_focalAngle:s,u_falloff:l,u_mixing:f,u_distortion:c,u_distortionShift:m,u_distortionFreq:d,u_grainMixer:n,u_grainOverlay:g,u_fit:v[h],u_rotation:x,u_scale:y,u_offsetX:b,u_offsetY:C,u_originX:w,u_originY:A,u_worldWidth:B,u_worldHeight:S};return(0,u.jsx)(p,{...k,speed:e,frame:o,fragmentShader:oW,uniforms:U})},d),oX=`#version 300 es
precision mediump float;
...
`,oH={name:"Default",params:{...g,fit:"cover",scale:.6,speed:0,frame:0,colorFront:"#9fadbc",colorBack:"#ffffff",contrast:.3,roughness:.4,fiber:.3,fiberSize:.2,crumples:.3,crumpleSize:.35,folds:.65,foldCount:5,fade:0,drops:.2,seed:5.8}},oL={name:"Abstract",params:{...g,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#00eeff",colorBack:"#ff0a81",contrast:.85,roughness:0,fiber:.1,fiberSize:.2,crumples:0,crumpleSize:.3,folds:1,foldCount:3,fade:0,drops:.2,seed:2.2}},oj=[oH,{name:"Cardboard",params:{...g,fit:"cover",speed:0,frame:0,scale:.6,colorFront:"#c7b89e",colorBack:"#999180",contrast:.4,roughness:0,fiber:.35,fiberSize:.14,crumples:.7,crumpleSize:.1,folds:0,foldCount:1,fade:0,drops:.1,seed:1.6}},oL,{name:"Details",params:{...g,speed:0,frame:0,fit:"cover",scale:3,colorFront:"#00000000",colorBack:"#00000000",contrast:0,roughness:1,fiber:.27,fiberSize:.22,crumples:1,crumpleSize:.5,folds:1,foldCount:15,fade:0,drops:0,seed:6}}],oK=(0,t.memo)(function({speed:e=oH.params.speed,frame:o=oH.params.frame,colorFront:a=oH.params.colorFront,colorBack:t=oH.params.colorBack,image:r="",contrast:i=oH.params.contrast,roughness:s=oH.params.roughness,fiber:l=oH.params.fiber,crumples:n=oH.params.crumples,folds:f=oH.params.folds,drops:c=oH.params.drops,seed:m=oH.params.seed,fiberScale:d,fiberSize:g=void 0===d?oH.params.fiberSize:.2/d,crumplesScale:h,crumpleSize:x=void 0===h?oH.params.crumpleSize:.2/h,blur:y,fade:w=void 0===y?oH.params.fade:y,foldsNumber:A,foldCount:b=void 0===A?oH.params.foldCount:A,fit:C=oH.params.fit,scale:B=oH.params.scale,rotation:S=oH.params.rotation,originX:k=oH.params.originX,originY:U=oH.params.originY,offsetX:R=oH.params.offsetX,offsetY:V=oH.params.offsetY,worldWidth:F=oH.params.worldWidth,worldHeight:z=oH.params.worldHeight,...M}){let I="undefined"!=typeof window&&{u_noiseTexture:Y()},O={u_image:r,u_colorFront:_(a),u_colorBack:_(t),u_contrast:i,u_roughness:s,u_fiber:l,u_fiberSize:g,u_crumples:n,u_crumpleSize:x,u_foldCount:b,u_folds:f,u_fade:w,u_drops:c,u_seed:m,...I,u_fit:v[C],u_scale:B,u_rotation:S,u_offsetX:R,u_offsetY:V,u_originX:k,u_originY:U,u_worldWidth:F,u_worldHeight:z};return(0,u.jsx)(p,{...M,speed:e,frame:o,fragmentShader:oX,mipmaps:["u_image"],uniforms:O})},d),oq=`#version 300 es
precision mediump float;
...
`,oJ={lines:1,linesIrregular:2,wave:3,zigzag:4,pattern:5},oZ={prism:1,lens:2,contour:3,cascade:4,flat:5},o$={name:"Default",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:.25,size:.5,angle:0,distortionShape:"prism",highlights:.1,shape:"lines",distortion:.5,shift:0,blur:0,edges:.25,stretch:0,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:0,grainOverlay:0}},o0={name:"Waves",params:{...g,fit:"cover",scale:1.2,speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:0,size:.9,angle:0,distortionShape:"contour",highlights:0,shape:"wave",distortion:.5,shift:0,blur:.1,edges:.5,stretch:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:0,grainOverlay:.05}},o1=[o$,{name:"Abstract",params:{...g,fit:"cover",scale:4,speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:0,size:.7,angle:30,distortionShape:"flat",highlights:0,shape:"linesIrregular",distortion:1,shift:0,blur:1,edges:.5,stretch:1,margin:0,marginLeft:0,marginRight:0,marginTop:0,marginBottom:0,grainMixer:.1,grainOverlay:.1}},o0,{name:"Folds",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#00000000",colorShadow:"#000000",colorHighlight:"#ffffff",shadows:.4,size:.4,angle:0,distortionShape:"cascade",highlights:0,shape:"lines",distortion:.75,shift:0,blur:.25,edges:.5,stretch:0,margin:.1,marginLeft:.1,marginRight:.1,marginTop:.1,marginBottom:.1,grainMixer:0,grainOverlay:0}}],o2=(0,t.memo)(function({speed:e=o$.params.speed,frame:o=o$.params.frame,colorBack:a=o$.params.colorBack,colorShadow:t=o$.params.colorShadow,colorHighlight:r=o$.params.colorHighlight,image:i="",shadows:s=o$.params.shadows,angle:l=o$.params.angle,distortion:n=o$.params.distortion,distortionShape:f=o$.params.distortionShape,highlights:c=o$.params.highlights,shape:m=o$.params.shape,shift:d=o$.params.shift,blur:g=o$.params.blur,edges:h=o$.params.edges,margin:x,marginLeft:y=x??o$.params.marginLeft,marginRight:w=x??o$.params.marginRight,marginTop:A=x??o$.params.marginTop,marginBottom:b=x??o$.params.marginBottom,grainMixer:C=o$.params.grainMixer,grainOverlay:B=o$.params.grainOverlay,stretch:S=o$.params.stretch,count:k,size:U=void 0===k?o$.params.size:Math.pow(1/(1.6*k),1/6)/.7-.5,fit:R=o$.params.fit,scale:V=o$.params.scale,rotation:F=o$.params.rotation,originX:z=o$.params.originX,originY:M=o$.params.originY,offsetX:I=o$.params.offsetX,offsetY:O=o$.params.offsetY,worldWidth:E=o$.params.worldWidth,worldHeight:Y=o$.params.worldHeight,...D}){let W={u_image:i,u_colorBack:_(a),u_colorShadow:_(t),u_colorHighlight:_(r),u_shadows:s,u_size:U,u_angle:l,u_distortion:n,u_shift:d,u_blur:g,u_edges:h,u_stretch:S,u_distortionShape:oZ[f],u_highlights:c,u_shape:oJ[m],u_marginLeft:y,u_marginRight:w,u_marginTop:A,u_marginBottom:b,u_grainMixer:C,u_grainOverlay:B,u_fit:v[R],u_scale:V,u_rotation:F,u_offsetX:I,u_offsetY:O,u_originX:z,u_originY:M,u_worldWidth:E,u_worldHeight:Y};return(0,u.jsx)(p,{...D,speed:e,frame:o,fragmentShader:oq,mipmaps:["u_image"],uniforms:W})}),o5=`#version 300 es
precision mediump float;
...
`,o3={name:"Default",params:{...g,scale:.8,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.07,layering:.5,edges:.8,waves:.3,caustic:.1,size:1}},o4={name:"Abstract",params:{...g,fit:"cover",scale:3,speed:1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:1,waves:1,caustic:.4,size:.15}},o8={name:"Streaming",params:{...g,fit:"contain",scale:.4,speed:2,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:0,layering:0,edges:0,waves:.5,caustic:0,size:.5}},o9=[o3,{name:"Slow-mo",params:{...g,fit:"cover",scale:1,speed:.1,frame:0,colorBack:"#909090",colorHighlight:"#ffffff",highlights:.4,layering:0,edges:0,waves:0,caustic:.2,size:.7}},o4,o8],o6=(0,t.memo)(function({speed:e=o3.params.speed,frame:o=o3.params.frame,colorBack:a=o3.params.colorBack,colorHighlight:t=o3.params.colorHighlight,image:r="",highlights:i=o3.params.highlights,layering:s=o3.params.layering,waves:l=o3.params.waves,edges:n=o3.params.edges,caustic:f=o3.params.caustic,effectScale:c,size:m=void 0===c?o3.params.size:10/9/c-1/9,fit:d=o3.params.fit,scale:g=o3.params.scale,rotation:h=o3.params.rotation,originX:x=o3.params.originX,originY:y=o3.params.originY,offsetX:w=o3.params.offsetX,offsetY:A=o3.params.offsetY,worldWidth:b=o3.params.worldWidth,worldHeight:C=o3.params.worldHeight,...B}){let S={u_image:r,u_colorBack:_(a),u_colorHighlight:_(t),u_highlights:i,u_layering:s,u_waves:l,u_edges:n,u_caustic:f,u_size:m,u_fit:v[d],u_rotation:h,u_scale:g,u_offsetX:w,u_offsetY:A,u_originX:x,u_originY:y,u_worldWidth:b,u_worldHeight:C};return(0,u.jsx)(p,{...B,speed:e,frame:o,fragmentShader:o5,mipmaps:["u_image"],uniforms:S})},d),o7=`#version 300 es
precision mediump float;
...
`,ae={name:"Default",params:{...g,fit:"cover",speed:0,frame:0,colorFront:"#94ffaf",colorBack:"#000c38",colorHighlight:"#eaff94",type:"8x8",size:2,colorSteps:2,originalColors:!1,inverted:!1}},ao={name:"Retro",params:{...g,fit:"cover",speed:0,frame:0,colorFront:"#eeeeee",colorBack:"#5452ff",colorHighlight:"#eeeeee",type:"2x2",size:3,colorSteps:1,originalColors:!0,inverted:!1}},aa=[ae,{name:"Noise",params:{...g,fit:"cover",speed:0,frame:0,colorFront:"#a2997c",colorBack:"#000000",colorHighlight:"#ededed",type:"random",size:1,colorSteps:1,originalColors:!1,inverted:!1}},ao,{name:"Natural",params:{...g,fit:"cover",speed:0,frame:0,colorFront:"#ffffff",colorBack:"#000000",colorHighlight:"#ffffff",type:"8x8",size:2,colorSteps:5,originalColors:!0,inverted:!1}}],at=(0,t.memo)(function({speed:e=ae.params.speed,frame:o=ae.params.frame,colorFront:a=ae.params.colorFront,colorBack:t=ae.params.colorBack,colorHighlight:r=ae.params.colorHighlight,image:i="",type:s=ae.params.type,colorSteps:l=ae.params.colorSteps,originalColors:n=ae.params.originalColors,inverted:f=ae.params.inverted,pxSize:c,size:m=void 0===c?ae.params.size:c,fit:d=ae.params.fit,scale:g=ae.params.scale,rotation:h=ae.params.rotation,originX:x=ae.params.originX,originY:y=ae.params.originY,offsetX:w=ae.params.offsetX,offsetY:A=ae.params.offsetY,worldWidth:b=ae.params.worldWidth,worldHeight:C=ae.params.worldHeight,...B}){let S={u_image:i,u_colorFront:_(a),u_colorBack:_(t),u_colorHighlight:_(r),u_type:oa[s],u_pxSize:m,u_colorSteps:l,u_originalColors:n,u_inverted:f,u_fit:v[d],u_rotation:h,u_scale:g,u_offsetX:w,u_offsetY:A,u_originX:x,u_originY:y,u_worldWidth:b,u_worldHeight:C};return(0,u.jsx)(p,{...B,speed:e,frame:o,fragmentShader:o7,uniforms:S})},d),ar={maxColorCount:10},ai=`#version 300 es
...
void main() {
  ...
  gradient.rgb *= gradient.a;
  float outerShape = 0.;
  for (int i = 1; i < ${ar.maxColorCount+1}; i++) {
    if (i > int(u_colorsCount)) break;
    float m = clamp(mixer - float(i - 1), 0., 1.);
    if (i == 1) {
      outerShape = m;
...
`;function as(e){let o=document.createElement("canvas");return new Promise((a,t)=>{let r=new Image;r.crossOrigin="anonymous",r.addEventListener("load",()=>{("string"==typeof e?e.endsWith(".svg"):"image/svg+xml"===e.type)&&(r.width=1e3,r.height=1e3);let i=r.naturalWidth/r.naturalHeight,s=Math.floor(150),l=Math.ceil(2.5*s),n=1e3,f=1e3;i>1?f=Math.floor(1e3/i):n=Math.floor(1e3*i),o.width=n+2*l,o.height=f+2*l;let c=o.getContext("2d",{willReadFrequently:!0});if(!c)throw Error("Failed to get canvas 2d context");c.fillStyle="white",c.fillRect(0,0,o.width,o.height),c.drawImage(r,l,l,n,f);let{width:u,height:m}=o,p=c.getImageData(0,0,u,m).data,d=u*m,g=new Uint8ClampedArray(d);for(let e=0;e<d;e++){let o=4*e,a=p[o]??0,t=p[o+1]??0,r=p[o+2]??0;g[e]=.299*a+.587*t+.114*r|0}let h=Math.max(1,Math.round(.12*s)),v=an(g,u,m,s,3),_=an(g,u,m,h,3),x=an(g,u,m,5,1),y=c.createImageData(u,m),w=y.data;for(let e=0;e<d;e++){let o=4*e;w[o]=x[e]??0,w[o+1]=v[e]??0,w[o+2]=_[e]??0,w[o+3]=255}c.putImageData(y,0,0),o.toBlob(e=>{if(!e)return void t(Error("Failed to create PNG blob"));a({blob:e})},"image/png")}),r.addEventListener("error",()=>{t(Error("Failed to load image"))}),r.src="string"==typeof e?e:URL.createObjectURL(e)})}function al(e,o,a,t){if(t<=0)return e.slice();let r=new Uint8ClampedArray(o*a),i=new Uint32Array(o*a);for(let t=0;t<a;t++){let a=0;for(let r=0;r<o;r++){let s=t*o+r;a+=e[s]??0,i[s]=a+(t>0?i[s-o]??0:0)}}for(let e=0;e<a;e++){let s=Math.max(0,e-t),l=Math.min(a-1,e+t);for(let a=0;a<o;a++){let n=Math.max(0,a-t),f=Math.min(o-1,a+t),c=l*o+f,u=l*o+(n-1),m=(s-1)*o+f,p=(s-1)*o+(n-1),d=i[c]??0,g=n>0?i[u]??0:0,h=d-g-(s>0?i[m]??0:0)+(n>0&&s>0?i[p]??0:0),v=(f-n+1)*(l-s+1);r[e*o+a]=Math.round(h/v)}}return r}function an(e,o,a,t,r){if(t<=0||r<=1)return al(e,o,a,t);let i=e,s=e;for(let e=0;e<r;e++)i=s=al(i,o,a,t);return s}let af="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==",ac=[],au=(e,o)=>(function(e,o=null){for(let a of(null===o&&(o=[e]),ac))if(function(e,o){if(e===o)return!0;if(!e||!o)return!1;let a=e.length;if(o.length!==a)return!1;for(let t=0;t<a;t++)if(e[t]!==o[t])return!1;return!0}(o,a.keys)){if(Object.prototype.hasOwnProperty.call(a,"error"))throw a.error;if(Object.prototype.hasOwnProperty.call(a,"response"))return a.response;throw a.promise}let a={keys:o,promise:("object"==typeof e&&"function"==typeof e.then?e:e(...o)).then(e=>{a.response=e}).catch(e=>a.error=e)};throw ac.push(a),a.promise})(e,o),am={name:"Default",params:{...g,scale:.75,speed:1,frame:0,contour:.5,angle:0,noise:0,innerGlow:.5,outerGlow:.5,colorBack:"#000000",colors:["#11206a","#1f3ba2","#2f63e7","#6bd7ff","#ffe679","#ff991e","#ff4c00"]}},ap=[am,{name:"Sepia",params:{...g,scale:.75,speed:.5,frame:0,contour:.5,angle:0,noise:.75,innerGlow:.5,outerGlow:.5,colorBack:"#000000",colors:["#997F45","#ffffff"]}}],ad=(0,t.memo)(function({speed:e=am.params.speed,frame:o=am.params.frame,image:a="",contour:r=am.params.contour,angle:i=am.params.angle,noise:s=am.params.noise,innerGlow:l=am.params.innerGlow,outerGlow:n=am.params.outerGlow,colorBack:f=am.params.colorBack,colors:c=am.params.colors,suspendWhenProcessingImage:m=!1,fit:d=am.params.fit,offsetX:g=am.params.offsetX,offsetY:h=am.params.offsetY,originX:x=am.params.originX,originY:y=am.params.originY,rotation:w=am.params.rotation,scale:A=am.params.scale,worldHeight:b=am.params.worldHeight,worldWidth:C=am.params.worldWidth,...B}){let S,k="string"==typeof a?a:a.src,[U,R]=(0,t.useState)(af);S=m&&"undefined"!=typeof window?au(()=>as(k).then(e=>URL.createObjectURL(e.blob)),[k,"heatmap"]):U,(0,t.useLayoutEffect)(()=>{if(m)return;if(!k)return void R(af);let e=!0;return as(k).then(o=>{e&&R(URL.createObjectURL(o.blob))}),()=>{e=!1}},[k,m]);let V=(0,t.useMemo)(()=>({u_image:S,u_contour:r,u_angle:i,u_noise:s,u_innerGlow:l,u_outerGlow:n,u_colorBack:_(f),u_colors:c.map(_),u_colorsCount:c.length,u_fit:v[d],u_offsetX:g,u_offsetY:h,u_originX:x,u_originY:y,u_rotation:w,u_scale:A,u_worldHeight:b,u_worldWidth:C}),[e,o,r,i,s,l,n,c,f,S,d,g,h,x,y,w,A,b,C]);return(0,u.jsx)(p,{...B,speed:e,frame:o,fragmentShader:ai,mipmaps:["u_image"],uniforms:V})},d),ag=`#version 300 es
precision mediump float;
...
`,ah={measurePerformance:!1,workingSize:512,iterations:40};function av(e){let o=document.createElement("canvas"),a=o.getContext("2d"),t="string"==typeof e&&e.startsWith("blob:");return new Promise((r,i)=>{if(!e||!a)return void i(Error("Invalid file or canvas context"));let s=t&&fetch(e).then(e=>e.headers.get("Content-Type")),l=new Image;l.crossOrigin="anonymous";let n=performance.now();l.onload=async()=>{let t,f=await s;t=f?"image/svg+xml"===f:"string"==typeof e?e.endsWith(".svg")||e.startsWith("data:image/svg+xml"):"image/svg+xml"===e.type;let c=l.width||l.naturalWidth,u=l.height||l.naturalHeight;if(t){let e=c/u;c>u?(c=4096,u=4096/e):(u=4096,c=4096*e),l.width=c,l.height=u}let m=Math.min(c,u),p=ah.workingSize/m,d=Math.round(c*p),g=Math.round(u*p);ah.measurePerformance&&(console.log("[Processing Mode]"),console.log(`  Original: ${c}\xd7${u}`),console.log(`  Working: ${d}\xd7${g} (${(100*p).toFixed(1)}% scale)`),p<1&&console.log(`  Speedup: ~${Math.round(1/(p*p))}\xd7`)),o.width=c,o.height=u;let h=document.createElement("canvas");h.width=d,h.height=g;let v=h.getContext("2d");v.drawImage(l,0,0,d,g);let _=performance.now(),x=v.getImageData(0,0,d,g).data,y=new Uint8Array(d*g),w=new Uint8Array(d*g),A=0;for(let e=0,o=0;e<x.length;e+=4,o++){let a=+(0!==x[e+3]);y[o]=a,A+=a}let b=[],C=[];for(let e=0;e<g;e++)for(let o=0;o<d;o++){let a=e*d+o;if(y[a])0!==o&&o!==d-1&&0!==e&&e!==g-1&&y[a-1]&&y[a+1]&&y[a-d]&&y[a+d]&&y[a-d-1]&&y[a-d+1]&&y[a+d-1]&&y[a+d+1]?C.push(a):(w[a]=1,b.push(a))}ah.measurePerformance&&(console.log(`[Mask Building] Time: ${(performance.now()-_).toFixed(2)}ms`),console.log(`  Shape pixels: ${A} / ${d*g} (${(A/(d*g)*100).toFixed(1)}%)`),console.log(`  Interior pixels: ${C.length}`),console.log(`  Boundary pixels: ${b.length}`));let B=function(e,o,a,t,r,i){let s=a.length,l=new Int32Array(4*s);for(let o=0;o<s;o++){let t=a[o],s=t%r,n=Math.floor(t/r);l[4*o+0]=s<r-1&&e[t+1]?t+1:-1,l[4*o+1]=s>0&&e[t-1]?t-1:-1,l[4*o+2]=n>0&&e[t-r]?t-r:-1,l[4*o+3]=n<i-1&&e[t+r]?t+r:-1}return{interiorPixels:a,boundaryPixels:t,pixelCount:s,neighborIndices:l}}(y,0,new Uint32Array(C),new Uint32Array(b),d,g),S=performance.now(),k=function(e,o,a,t,r){let i=ah.iterations,s=new Float32Array(t*r),{interiorPixels:l,neighborIndices:n,pixelCount:f}=e,c=performance.now(),u=[],m=[];for(let e=0;e<f;e++){let o=l[e];(o%t+Math.floor(o/t))%2==0?u.push(e):m.push(e)}for(let e=0;e<i;e++){for(let e of u){let o=l[e],a=n[4*e+0],t=n[4*e+1],r=n[4*e+2],i=n[4*e+3],f=0;a>=0&&(f+=s[a]),t>=0&&(f+=s[t]),r>=0&&(f+=s[r]),i>=0&&(f+=s[i]);let c=(.01+f)/4;s[o]=1.9*c+-.8999999999999999*s[o]}for(let e of m){let o=l[e],a=n[4*e+0],t=n[4*e+1],r=n[4*e+2],i=n[4*e+3],f=0;a>=0&&(f+=s[a]),t>=0&&(f+=s[t]),r>=0&&(f+=s[r]),i>=0&&(f+=s[i]);let c=(.01+f)/4;s[o]=1.9*c+-.8999999999999999*s[o]}}if(ah.measurePerformance){let e=performance.now()-c;console.log(`[Optimized Poisson Solver (SOR \u03C9=1.9)]`),console.log(`  Working size: ${t}\xd7${r}`),console.log(`  Iterations: ${i}`),console.log(`  Time: ${e.toFixed(2)}ms`),console.log(`  Interior pixels processed: ${f}`),console.log(`  Speed: ${(i*f/(1e3*e)).toFixed(2)} Mpixels/sec`)}return s}(B,0,0,d,g);ah.measurePerformance&&console.log(`[Poisson Solve] Time: ${(performance.now()-S).toFixed(2)}ms`);let U=0;for(let e=0;e<C.length;e++){let o=C[e];k[o]>U&&(U=k[o])}let R=document.createElement("canvas");R.width=d,R.height=g;let V=R.getContext("2d"),F=V.createImageData(d,g);for(let e=0;e<g;e++)for(let o=0;o<d;o++){let a=e*d+o,t=4*a;if(y[a]){let e=255*(1-k[a]/U);F.data[t]=e,F.data[t+1]=e,F.data[t+2]=e,F.data[t+3]=255}else F.data[t]=255,F.data[t+1]=255,F.data[t+2]=255,F.data[t+3]=0}V.putImageData(F,0,0),a.imageSmoothingEnabled=!0,a.imageSmoothingQuality="high",a.drawImage(R,0,0,d,g,0,0,c,u);let z=a.getImageData(0,0,c,u),M=document.createElement("canvas");M.width=c,M.height=u;let I=M.getContext("2d");I.drawImage(l,0,0,c,u);let O=I.getImageData(0,0,c,u);for(let e=0;e<z.data.length;e+=4){let o=O.data[e+3],a=z.data[e+3];0===o?(z.data[e]=255,z.data[e+1]=0):(z.data[e]=0===a?0:z.data[e],z.data[e+1]=o),z.data[e+2]=255,z.data[e+3]=255}a.putImageData(z,0,0),o.toBlob(e=>{if(!e)return void i(Error("Failed to create PNG blob"));if(ah.measurePerformance){let e=performance.now()-n;if(console.log(`[Total Processing Time] ${e.toFixed(2)}ms`),p<1){let o=e*Math.pow(c*u/(d*g),1.5);console.log(`[Estimated time at full resolution] ~${o.toFixed(0)}ms`),console.log(`[Time saved] ~${(o-e).toFixed(0)}ms (${Math.round(o/e)}\xd7 faster)`)}}r({imageData:z,pngBlob:e})},"image/png")},l.onerror=()=>i(Error("Failed to load image")),l.src="string"==typeof e?e:URL.createObjectURL(e)})}let a_={none:0,circle:1,daisy:2,diamond:3,metaballs:4},ax={name:"Default",params:{...g,scale:.6,speed:1,frame:0,colorBack:"#AAAAAC",colorTint:"#ffffff",distortion:.07,repetition:2,shiftRed:.3,shiftBlue:.3,contour:.4,softness:.1,angle:70,shape:"diamond"}},ay={name:"Noir",params:{...g,scale:.6,speed:1,frame:0,colorBack:"#000000",colorTint:"#606060",softness:.45,repetition:1.5,shiftRed:0,shiftBlue:0,distortion:0,contour:0,angle:90,shape:"diamond"}},aw=[ax,ay,{name:"Backdrop",params:{...g,speed:1,frame:0,scale:1.5,colorBack:"#AAAAAC",colorTint:"#ffffff",softness:.05,repetition:1.5,shiftRed:.3,shiftBlue:.3,distortion:.1,contour:.4,shape:"none",angle:90,worldWidth:0,worldHeight:0}},{name:"Stripes",params:{...g,speed:1,frame:0,scale:.6,colorBack:"#000000",colorTint:"#2c5d72",softness:.8,repetition:6,shiftRed:1,shiftBlue:-1,distortion:.4,contour:.4,shape:"circle",angle:0}}],aA=(0,t.memo)(function({colorBack:e=ax.params.colorBack,colorTint:o=ax.params.colorTint,speed:a=ax.params.speed,frame:r=ax.params.frame,image:i="",contour:s=ax.params.contour,distortion:l=ax.params.distortion,softness:n=ax.params.softness,repetition:f=ax.params.repetition,shiftRed:c=ax.params.shiftRed,shiftBlue:m=ax.params.shiftBlue,angle:d=ax.params.angle,shape:g=ax.params.shape,suspendWhenProcessingImage:h=!1,fit:x=ax.params.fit,scale:y=ax.params.scale,rotation:w=ax.params.rotation,originX:A=ax.params.originX,originY:b=ax.params.originY,offsetX:C=ax.params.offsetX,offsetY:B=ax.params.offsetY,worldWidth:S=ax.params.worldWidth,worldHeight:k=ax.params.worldHeight,...U}){let R,V="string"==typeof i?i:i.src,[F,z]=(0,t.useState)(af);R=h&&"undefined"!=typeof window&&V?au(()=>av(V).then(e=>URL.createObjectURL(e.pngBlob)),[V,"liquid-metal"]):F,(0,t.useLayoutEffect)(()=>{if(h)return;if(!V)return void z(af);let e=!0;return av(V).then(o=>{e&&z(URL.createObjectURL(o.pngBlob))}),()=>{e=!1}},[V,h]);let M={u_colorBack:_(e),u_colorTint:_(o),u_image:R,u_contour:s,u_distortion:l,u_softness:n,u_repetition:f,u_shiftRed:c,u_shiftBlue:m,u_angle:d,u_isImage:!!i,u_shape:a_[g],u_fit:v[x],u_scale:y,u_rotation:w,u_offsetX:C,u_offsetY:B,u_originX:A,u_originY:b,u_worldWidth:S,u_worldHeight:k};return(0,u.jsx)(p,{...U,speed:a,frame:r,fragmentShader:ag,mipmaps:["u_image"],uniforms:M})}),ab=`#version 300 es
precision mediump float;
...
`,aC={classic:0,gooey:1,holes:2,soft:3},aB={square:0,hex:1},aS={name:"Default",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#f2f1e8",colorFront:"#2b2b2b",size:.5,radius:1.25,contrast:.4,originalColors:!1,inverted:!1,grainMixer:.2,grainOverlay:.2,grainSize:.5,grid:"hex",type:"gooey"}},ak={name:"LED screen",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#000000",colorFront:"#29ff7b",size:.5,radius:1.5,contrast:.3,originalColors:!1,inverted:!1,grainMixer:0,grainOverlay:0,grainSize:.5,grid:"square",type:"soft"}},aU=[aS,ak,{name:"Mosaic",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#000000",colorFront:"#b2aeae",size:.6,radius:2,contrast:.01,originalColors:!0,inverted:!1,grainMixer:0,grainOverlay:0,grainSize:.5,grid:"hex",type:"classic"}},{name:"Round and square",params:{...g,fit:"cover",speed:0,frame:0,colorBack:"#141414",colorFront:"#ff8000",size:.8,radius:1,contrast:1,originalColors:!1,inverted:!0,grainMixer:.05,grainOverlay:.3,grainSize:.5,grid:"square",type:"holes"}}],aR=(0,t.memo)(function({speed:e=aS.params.speed,frame:o=aS.params.frame,colorFront:a=aS.params.colorFront,colorBack:t=aS.params.colorBack,image:r="",size:i=aS.params.size,radius:s=aS.params.radius,contrast:l=aS.params.contrast,originalColors:n=aS.params.originalColors,inverted:f=aS.params.inverted,grainMixer:c=aS.params.grainMixer,grainOverlay:m=aS.params.grainOverlay,grainSize:d=aS.params.grainSize,grid:g=aS.params.grid,type:h=aS.params.type,fit:x=aS.params.fit,scale:y=aS.params.scale,rotation:w=aS.params.rotation,originX:A=aS.params.originX,originY:b=aS.params.originY,offsetX:C=aS.params.offsetX,offsetY:B=aS.params.offsetY,worldWidth:S=aS.params.worldWidth,worldHeight:k=aS.params.worldHeight,...U}){let R={u_image:r,u_colorFront:_(a),u_colorBack:_(t),u_size:i,u_radius:s,u_contrast:l,u_originalColors:n,u_inverted:f,u_grainMixer:c,u_grainOverlay:m,u_grainSize:d,u_grid:aB[g],u_type:aC[h],u_fit:v[x],u_rotation:w,u_scale:y,u_offsetX:C,u_offsetY:B,u_originX:A,u_originY:b,u_worldWidth:S,u_worldHeight:k};return(0,u.jsx)(p,{...U,speed:e,frame:o,fragmentShader:ab,uniforms:R})},d),aV=`#version 300 es
precision mediump float;
...
`,aF={dots:0,ink:1,sharp:2},az={name:"Default",params:{...g,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#fbfaf5",colorC:"#00b4ff",colorM:"#fc519f",colorY:"#ffd800",colorK:"#231f20",size:.2,contrast:1,softness:1,grainSize:.5,grainMixer:0,grainOverlay:0,gridNoise:.2,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:.3,gainM:0,gainY:.2,gainK:0,type:"ink"}},aM={name:"Drops",params:{...g,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#eeefd7",colorC:"#00b2ff",colorM:"#fc4f4f",colorY:"#ffd900",colorK:"#231f20",size:.88,contrast:1.15,softness:0,grainSize:.01,grainMixer:.05,grainOverlay:.25,gridNoise:.5,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:1,gainM:.44,gainY:-1,gainK:0,type:"ink"}},aI=[az,aM,{name:"Newspaper",params:{...g,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#f2f1e8",colorC:"#7a7a75",colorM:"#7a7a75",colorY:"#7a7a75",colorK:"#231f20",size:.01,contrast:2,softness:.2,grainSize:0,grainMixer:0,grainOverlay:.2,gridNoise:.6,floodC:0,floodM:0,floodY:0,floodK:.1,gainC:-.17,gainM:-.45,gainY:-.45,gainK:0,type:"dots"}},{name:"Vintage",params:{...g,scale:1,fit:"cover",speed:0,frame:0,colorBack:"#fffaf0",colorC:"#59afc5",colorM:"#d8697c",colorY:"#fad85c",colorK:"#2d2824",size:.2,contrast:1.25,softness:.4,grainSize:.5,grainMixer:.15,grainOverlay:.1,gridNoise:.45,floodC:.15,floodM:0,floodY:0,floodK:0,gainC:.3,gainM:0,gainY:.2,gainK:0,type:"sharp"}}],aO=(0,t.memo)(function({speed:e=az.params.speed,frame:o=az.params.frame,colorBack:a=az.params.colorBack,colorC:t=az.params.colorC,colorM:r=az.params.colorM,colorY:i=az.params.colorY,colorK:s=az.params.colorK,image:l="",size:n=az.params.size,contrast:f=az.params.contrast,softness:c=az.params.softness,grainSize:m=az.params.grainSize,grainMixer:d=az.params.grainMixer,grainOverlay:g=az.params.grainOverlay,gridNoise:h=az.params.gridNoise,floodC:x=az.params.floodC,floodM:y=az.params.floodM,floodY:w=az.params.floodY,floodK:A=az.params.floodK,gainC:b=az.params.gainC,gainM:C=az.params.gainM,gainY:B=az.params.gainY,gainK:S=az.params.gainK,type:k=az.params.type,fit:U=az.params.fit,scale:R=az.params.scale,rotation:V=az.params.rotation,originX:F=az.params.originX,originY:z=az.params.originY,offsetX:M=az.params.offsetX,offsetY:I=az.params.offsetY,worldWidth:O=az.params.worldWidth,worldHeight:E=az.params.worldHeight,...D}){let W={u_image:l,u_noiseTexture:Y(),u_colorBack:_(a),u_colorC:_(t),u_colorM:_(r),u_colorY:_(i),u_colorK:_(s),u_size:n,u_contrast:f,u_softness:c,u_grainSize:m,u_grainMixer:d,u_grainOverlay:g,u_gridNoise:h,u_floodC:x,u_floodM:y,u_floodY:w,u_floodK:A,u_gainC:b,u_gainM:C,u_gainY:B,u_gainK:S,u_type:aF[k],u_fit:v[U],u_rotation:V,u_scale:R,u_offsetX:M,u_offsetY:I,u_originX:F,u_originY:z,u_worldWidth:O,u_worldHeight:E};return(0,u.jsx)(p,{...D,speed:e,frame:o,fragmentShader:aV,uniforms:W})},d)}}]);